                ...
                <div class="row" style=" ">
                    <div class="col-md-12 col-sm-12 col-xs-12" style="width:100%; ">
                        <div class="p-t-30 p-b-80" style="padding-top:20px; padding-bottom:70px">
                            <h1 class="color_white" style="font-size:40px; color:#fff; text-align: center">Hello, {{ $user->first_name.' '.$user->last_name}}</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row" style="">
                    <div class="col-md-12 col-sm-12 col-xs-12" style="width:100%; ">
                        ...
                        <div class="text-center m-t-30 m-b-30" style="margin-top:30px; margin-bottom:30px; text-align:center">
                            <a href="#" class="btn btn-gry" style="border:1px white solid !important; font-size:15px; font-weight:normal; line-height:30px;  border-radius:0!important; margin-right:10px; background:#0c4e8c !important; color:#fff !important; padding:6px 16px;
