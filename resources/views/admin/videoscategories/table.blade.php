        ...
        <tr>
            ...
            <td class="">
                ...
                <div class="d-flex flex-column">
                    <a href="{{ route('admin.videoscategories.edit', $category->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $category->title ?? ''}}</a>
                </div>
                <!--begin::User details-->
            </td>
            <!--end::User=-->
            ...
            <td class="text-end">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <a href="{{ route('admin.videoscategories.edit', $category->id) }}" class="menu-link px-3">Edit</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <div class="swal2-actions" style="display: flex;">
                            ...
                            {!! Form::model($category, ['route' => ['admin.videoscategories.destroy', $category->id], 'method' => 'delete']) !!}
