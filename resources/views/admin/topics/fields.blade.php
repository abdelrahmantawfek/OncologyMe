...
<div class="form-group col-sm-12 fv-row mb-10 fv-plugins-icon-container">
    {!! Form::label('is_main', 'Is parent topic :', ['class' => 'form-label fs-6 fw-bolder text-dark']) !!}
...
<div class="form-group col-sm-6 fv-row mb-10 fv-plugins-icon-container" id="parent_field">
    {!! Form::label('parent_id', 'Select parent topic :', ['class' => 'form-label fs-6 fw-bolder text-dark']) !!}
    {!! Form::select('parent_id', $parent_topic, null, ['class' => 'form-control form-select form-control-lg form-control-solid', 'placeholder' => 'Select parent topic']) !!}
</div>

<!-- is main Field -->
<div class="form-group col-sm-6 fv-row mb-10 fv-plugins-icon-container" id="main_field">
    {!! Form::label('is_main', 'Is main topic :', ['class' => 'form-label fs-6 fw-bolder text-dark']) !!}
    <label class="form-check form-check-sm form-check-custom form-check-solid">
