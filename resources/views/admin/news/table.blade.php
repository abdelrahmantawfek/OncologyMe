        ...
        <tr>
            ...
            <td>
                ...
                {{-- <div class="d-flex flex-column"> --}}
                    <a href="{{ route('admin.news.edit', $post->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $post->title ?? ''}}</a>
                {{-- </div> --}}
                <!--begin::User details-->
            </td>
            <!--end::User-->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <div class="swal2-actions" style="display: flex;">
                            ...
                            {!! Form::model($post, ['route' => ['admin.news.destroy', $post->id], 'method' => 'delete']) !!}
