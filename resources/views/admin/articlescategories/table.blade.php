...
<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
    ...
    <tbody class="text-gray-600 fw-bold">
        ...
        <tr>
            ...
            <td class="">
                ...
                <div class="d-flex flex-column">
                    <a href="{{ route('admin.articlescategories.edit', $category->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $category->title ?? ''}}</a>
                </div>
                <!--begin::User details-->
            </td>
            <!--end::User=-->
            ...
            <td class="text-end">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <a href="{{ route('admin.articlescategories.edit', $category->id) }}" class="menu-link px-3">Edit</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="" class="menu-link px-3" data-kt-users-table-filter="delete_row" data-bs-toggle="modal" data-bs-target="#delete_item-{{$category->id}}">Delete</a>
                    </div>
                    <!--end::Menu item-->
                </div>
                <!--end::Menu-->
        ...
        <div class="modal fade" id="delete_item-{{$category->id}}" tabindex="-1" role="dialog" aria-labelledby="delete_item" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <div class="swal2-html-container my-15" id="" style="display: block;">Are you sure you want to delete {{ $category->title ?? ''}}?</div>
                        <div class="swal2-actions" style="display: flex;">
                            <div class="swal2-loader"></div>
                            {!! Form::model($category, ['route' => ['admin.articlescategories.destroy', $category->id], 'method' => 'delete']) !!}
