...
<!-- is main Field -->
<div class="form-group col-sm-6 fv-row mb-10 fv-plugins-icon-container">
    {!! Form::label('is_main', 'Is main category :', ['class' => 'form-label fs-6 fw-bolder text-dark']) !!}
    ...
    <small>please select Yes to add category in the menu under news tab</small>
</div>
...
<div class="form-group col-sm-12 fv-row mb-10 fv-plugins-icon-container">
    ...
    <a href="{{ route('admin.articlescategories.index') }}" class="btn btn-secondary">Cancel</a>
</div>
